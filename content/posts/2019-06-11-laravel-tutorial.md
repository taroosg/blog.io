...
![更新画面表示](img/20190611-view-edit.png)
...
![登録ページ](img/20190611-view-register.png)
...
ターミナルで以下を実行する．作業ディレクトリが「`/project01`」であることを必ず確認すること．
```bash
...
ターミナルで以下を実行．作業ディレクトリが「`/project01`」であることを確認すること．以降のターミナル操作も同様．
...
最後に，ログイン中にしかAPIを実行させないため，`/project01/app/Http/Kernel.php`に以下を追記する．
