...
![初期ビュー](./images/20190208-view-example.png)
...
![コンポーネント表示](./images/20190208-vue-component.png)
...
![ナビゲーション表示](./images/20190208-vue-navigation.png)
...
![フォーム表示](./images/20190208-vue-form.png)
...
![タスク表示確認](./images/20190208-vue-index.png)
...
![編集ページ表示](./images/20190208-vue-edit.png)

続いて，更新の処理を実行する．上記の編集ページで値を任意に変更し，Updateボタンをクリックする．一覧画面に移動して内容が更新されていればOK．

![更新処理確認](./images/20190208-vue-update.png)
